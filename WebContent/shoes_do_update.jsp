...
<body>
<!-- <%=request.getParameter("shoes_id") %></p> --><p>
<%
    Factory.getIEmpDAOInstance().update_shoes(request.getParameter("shoes_id"), request.getParameter("store_id"), Integer.parseInt(request.getParameter("amount")), request.getParameter("size"), request.getParameter("color"));
	String store_id=session.getAttribute("storeid").toString();
	
	List<Stock>all=Factory.getIEmpDAOInstance().findStockByStore_id(request.getParameter("store_id"),request.getParameter("shoes_id"));
